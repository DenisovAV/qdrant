// On-DEVICE full-surface operation coverage for the Qdrant Edge SDK.
// Identical scenarios to test/operations_test.dart, run through the Flutter
// integration_test harness so the SAME suite executes on iOS / Android /
// desktop against the prebuilt (or host-built) native engine.
//
// Run: flutter test integration_test/operations_test.dart -d <device>
